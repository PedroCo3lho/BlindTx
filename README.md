...
In Brazil we don't have an Tokenized Certifier, in order to fill this gap our solutions aims to certify not only the commmunity programs but also college extension hours, on-site courses, and bootcamps. By certifing other programs We will require a small fee based on the number of eligible users + the gas prices. 

## Project Stack
- [Solidity Smart Contract](https://sepolia-optimism.etherscan.io/token/0x8bc787dc43cf0f1cf76c00d8c38b35c76c3cf624) deployed on Optimism Sepolia for PoC (sooner is going to be on mainnet)
...
<img width="3200" alt="Web3EduBrasil Tech Stack" src="https://github.com/user-attachments/assets/d0e143a0-7712-4719-9d82-50709889b776" />
